      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/agents#leaderboard" className="text-white/50 hover:text-white text-xs transition-colors underline-hover font-mono">
                  Leaderboard
                </Link>
              </li>
              <li>
                <Link href="/agents#submit" className="text-white/50 hover:text-white text-xs transition-colors underline-hover font-mono">
                  Submit Agent
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://x.com/rektsagents" target="_blank" rel="noreferrer" className="text-white/50 hover:text-white text-xs transition-colors underline-hover font-mono flex items-center gap-1.5">
