...
const phases = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Reward calculator / simulator', done: true },
      { text: 'Agent starter templates (Python, Node.js, Solidity)', done: true },
      { text: 'Real agent analytics (time-series data)', done: true },
